...
export default function FinalPhase({ notifyEmail, setNotifyEmail, submitNotify, notifyMessage }) {
  return (
    <section className="mx-auto mt-10 max-w-xl animate-fadeIn">
      <div className="rounded-3xl border border-emerald-300/25 bg-black/55 p-6 text-center backdrop-blur">
        ...
        <form onSubmit={submitNotify} className="mt-5 space-y-3">
          ...
          />
          <button type="submit" className="w-full rounded-xl bg-gradient-to-r from-emerald-500 to-lime-500 px-4 py-3 text-sm font-bold text-zinc-950">
            Notify Me
          </button>
        </form>
